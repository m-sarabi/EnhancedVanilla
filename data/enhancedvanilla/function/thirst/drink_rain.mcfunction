execute as @a[x_rotation=-90..-80] if predicate enhancedvanilla:is_under_rain run scoreboard players add @s ev.drink_rain 1
execute as @a[x_rotation=-80..90] run scoreboard players set @s ev.drink_rain 0
execute as @a unless predicate enhancedvanilla:is_under_rain run scoreboard players set @s ev.drink_rain 0
